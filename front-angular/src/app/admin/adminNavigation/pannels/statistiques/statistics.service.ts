...
export class StatisticsService {
  ...
  getAllStats() {
    ...
    //Evolution nbr visiteurs
    this.httpClient.get<any>(environment.apiUrl + '/stats/visitorEvolution').subscribe(
      (response) => {
        console.log(response)
        this.mapStats["evolutionVisitor"] = response["value"];
        this.emitMapStatsSubject();
      },
      (error) => {
        console.log('Erreur ! : ' + error);
  ...
  addImpression() {
    this.httpClient.get<any>(environment.apiUrl + '/stats/addImpression').subscribe(
      (response) => {
        console.log('Impression ajoutée avec succès');
      },
      (error) => {
        console.log('Erreur ! : ' + error);
      }
